...
class InternationalNames:
    ...
    """
    swagger_types = {"display_name": "dict(str, str)"}
    attribute_map = {"display_name": "display_name"}

    def __init__(self, display_name=None):
        """InternationalNames - a model defined in Swagger."""
    ...
    def display_name(self):
        """Gets the display_name of this InternationalNames.
        Display name in various languages (key is language code)
        :return: The display_name of this InternationalNames.
        :rtype: dict(str, str).
        """
    ...
    def display_name(self, display_name):
        """Sets the display_name of this InternationalNames.
        Display name in various languages (key is language code)
        :param display_name: The display_name of this InternationalNames.
        :type: dict(str, str).
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(InternationalNames, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, InternationalNames):
            return False
