...
class TextTopicsResultsMeta:
    ...
    """
    swagger_types = {"topics_count": "int"}
    attribute_map = {"topics_count": "topics_count"}

    def __init__(self, topics_count=None):
        """TextTopicsResultsMeta - a model defined in Swagger."""
    ...
    def topics_count(self):
        """Gets the topics_count of this TextTopicsResultsMeta.
        :return: The topics_count of this TextTopicsResultsMeta.
        :rtype: int.
        """
    ...
    def topics_count(self, topics_count):
        """Sets the topics_count of this TextTopicsResultsMeta.
        :param topics_count: The topics_count of this TextTopicsResultsMeta.
        :type: int.
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(TextTopicsResultsMeta, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TextTopicsResultsMeta):
            return False
