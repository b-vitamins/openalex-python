...
class AutocompleteResults:
    ...
    """
    swagger_types = {"meta": "Meta", "results": "list[AutocompleteResult]"}
    attribute_map = {"meta": "meta", "results": "results"}

    def __init__(self, meta=None, results=None):
        """AutocompleteResults - a model defined in Swagger."""
        self._meta = None
        self._results = None
    ...
    @property
    def meta(self):
        """Gets the meta of this AutocompleteResults.
        :return: The meta of this AutocompleteResults.
        :rtype: Meta.
        """
        return self._meta
    ...
    @meta.setter
    def meta(self, meta):
        """Sets the meta of this AutocompleteResults.
        :param meta: The meta of this AutocompleteResults.
        :type: Meta.
        """
        if meta is None:
    ...
    @property
    def results(self):
        """Gets the results of this AutocompleteResults.
        :return: The results of this AutocompleteResults.
    ...
    def results(self, results):
        """Sets the results of this AutocompleteResults.
        :param results: The results of this AutocompleteResults.
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(AutocompleteResults, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AutocompleteResults):
            return False
