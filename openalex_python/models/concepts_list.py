...
class ConceptsList:
    ...
    def __init__(self, meta=None, results=None, group_by=None):
        """ConceptsList - a model defined in Swagger."""
        self._meta = None
        self._results = None
        self._group_by = None
    ...
    @property
    def meta(self):
        """Gets the meta of this ConceptsList.
        :return: The meta of this ConceptsList.
        :rtype: Meta.
        """
        return self._meta
    ...
    @meta.setter
    def meta(self, meta):
        """Sets the meta of this ConceptsList.
        :param meta: The meta of this ConceptsList.
        :type: Meta.
        """
        if meta is None:
    ...
    @property
    def results(self):
        """Gets the results of this ConceptsList.
        :return: The results of this ConceptsList.
        :rtype: list[Concept].
        """
    ...
    def results(self, results):
        """Sets the results of this ConceptsList.
        :param results: The results of this ConceptsList.
        :type: list[Concept].
        """
        if results is None:
    ...
    @property
    def group_by(self):
        """Gets the group_by of this ConceptsList.
        :return: The group_by of this ConceptsList.
        :rtype: GroupByResult.
        """
    ...
    def group_by(self, group_by):
        """Sets the group_by of this ConceptsList.
        :param group_by: The group_by of this ConceptsList.
        :type: GroupByResult.
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ConceptsList, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ConceptsList):
            return False
