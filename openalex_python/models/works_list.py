...
class WorksList:
    ...
    def __init__(self, meta=None, results=None, group_by=None):
        """WorksList - a model defined in Swagger."""
        self._meta = None
        self._results = None
        self._group_by = None
    ...
    @property
    def meta(self):
        """Gets the meta of this WorksList.
        :return: The meta of this WorksList.
        :rtype: Meta.
        """
        return self._meta
    ...
    @meta.setter
    def meta(self, meta):
        """Sets the meta of this WorksList.
        :param meta: The meta of this WorksList.
        :type: Meta.
        """
        if meta is None:
    ...
    @property
    def results(self):
        """Gets the results of this WorksList.
        :return: The results of this WorksList.
        :rtype: list[Work].
        """
    ...
    def results(self, results):
        """Sets the results of this WorksList.
        :param results: The results of this WorksList.
        :type: list[Work].
        """
        if results is None:
    ...
    @property
    def group_by(self):
        """Gets the group_by of this WorksList.
        :return: The group_by of this WorksList.
        :rtype: GroupByResult.
        """
    ...
    def group_by(self, group_by):
        """Sets the group_by of this WorksList.
        :param group_by: The group_by of this WorksList.
        :type: GroupByResult.
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, WorksList):
            return False
