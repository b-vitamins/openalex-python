...
class DehydratedPublisher:
    ...
    attribute_map = {"id": "id", "display_name": "display_name"}

    def __init__(self, id=None, display_name=None):
        """DehydratedPublisher - a model defined in Swagger."""
        self._id = None
    ...
    @property
    def id(self):
        """Gets the id of this DehydratedPublisher.
        :return: The id of this DehydratedPublisher.
        :rtype: str.
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this DehydratedPublisher.
        :param id: The id of this DehydratedPublisher.
        :type: str.
        """
        if id is None:
    ...
    def display_name(self):
        """Gets the display_name of this DehydratedPublisher.
        :return: The display_name of this DehydratedPublisher.
        :rtype: str.
        """
    ...
    def display_name(self, display_name):
        """Sets the display_name of this DehydratedPublisher.
        :param display_name: The display_name of this DehydratedPublisher.
        :type: str.
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(DehydratedPublisher, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DehydratedPublisher):
            return False
