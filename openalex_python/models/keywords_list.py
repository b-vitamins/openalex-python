...
class KeywordsList:
    ...
    def __init__(self, meta=None, results=None, group_by=None):
        """KeywordsList - a model defined in Swagger."""
        self._meta = None
        self._results = None
        self._group_by = None
    ...
    @property
    def meta(self):
        """Gets the meta of this KeywordsList.
        :return: The meta of this KeywordsList.
        :rtype: Meta.
        """
        return self._meta
    ...
    @meta.setter
    def meta(self, meta):
        """Sets the meta of this KeywordsList.
        :param meta: The meta of this KeywordsList.
        :type: Meta.
        """
        if meta is None:
    ...
    @property
    def results(self):
        """Gets the results of this KeywordsList.
        :return: The results of this KeywordsList.
        :rtype: list[Keyword].
        """
    ...
    def results(self, results):
        """Sets the results of this KeywordsList.
        :param results: The results of this KeywordsList.
        :type: list[Keyword].
        """
        if results is None:
    ...
    @property
    def group_by(self):
        """Gets the group_by of this KeywordsList.
        :return: The group_by of this KeywordsList.
        :rtype: GroupByResult.
        """
    ...
    def group_by(self, group_by):
        """Sets the group_by of this KeywordsList.
        :param group_by: The group_by of this KeywordsList.
        :type: GroupByResult.
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(KeywordsList, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, KeywordsList):
            return False
