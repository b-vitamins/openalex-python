...
class AllOfTextConceptsResultsConceptsItems(Concept):
    ...
    if hasattr(Concept, "swagger_types"):
        swagger_types.update(Concept.swagger_types)
    attribute_map = {"score": "score"}
    if hasattr(Concept, "attribute_map"):
        attribute_map.update(Concept.attribute_map)

    def __init__(self, score=None, *args, **kwargs):
        """AllOfTextConceptsResultsConceptsItems - a model defined in Swagger."""
        self._score = None
        self.discriminator = None
        if score is not None:
            self.score = score
        Concept.__init__(self, *args, **kwargs)

    @property
    def score(self):
        """Gets the score of this AllOfTextConceptsResultsConceptsItems.
        :return: The score of this AllOfTextConceptsResultsConceptsItems.
        :rtype: float.
        """
        return self._score
    ...
    def score(self, score):
        """Sets the score of this AllOfTextConceptsResultsConceptsItems.
        :param score: The score of this AllOfTextConceptsResultsConceptsItems.
        :type: float.
        """
        self._score = score
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(AllOfTextConceptsResultsConceptsItems, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AllOfTextConceptsResultsConceptsItems):
            return False
