...
class PublishersList:
    ...
    def __init__(self, meta=None, results=None, group_by=None):
        """PublishersList - a model defined in Swagger."""
        self._meta = None
        self._results = None
        self._group_by = None
    ...
    @property
    def meta(self):
        """Gets the meta of this PublishersList.
        :return: The meta of this PublishersList.
        :rtype: Meta.
        """
        return self._meta
    ...
    @meta.setter
    def meta(self, meta):
        """Sets the meta of this PublishersList.
        :param meta: The meta of this PublishersList.
        :type: Meta.
        """
        if meta is None:
    ...
    @property
    def results(self):
        """Gets the results of this PublishersList.
        :return: The results of this PublishersList.
    ...
    def results(self, results):
        """Sets the results of this PublishersList.
        :param results: The results of this PublishersList.
        :type: list[Publisher].
        """
        if results is None:
    ...
    @property
    def group_by(self):
        """Gets the group_by of this PublishersList.
        :return: The group_by of this PublishersList.
        :rtype: GroupByResult.
        """
    ...
    def group_by(self, group_by):
        """Sets the group_by of this PublishersList.
        :param group_by: The group_by of this PublishersList.
        :type: GroupByResult.
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(PublishersList, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PublishersList):
            return False
