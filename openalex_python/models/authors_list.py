...
class AuthorsList:
    ...
    def __init__(self, meta=None, results=None, group_by=None):
        """AuthorsList - a model defined in Swagger."""
        self._meta = None
        self._results = None
        self._group_by = None
    ...
    @property
    def meta(self):
        """Gets the meta of this AuthorsList.
        :return: The meta of this AuthorsList.
        :rtype: Meta.
        """
        return self._meta
    ...
    @meta.setter
    def meta(self, meta):
        """Sets the meta of this AuthorsList.
        :param meta: The meta of this AuthorsList.
        :type: Meta.
        """
        if meta is None:
    ...
    @property
    def results(self):
        """Gets the results of this AuthorsList.
        :return: The results of this AuthorsList.
        :rtype: list[Author].
        """
    ...
    def results(self, results):
        """Sets the results of this AuthorsList.
        :param results: The results of this AuthorsList.
        :type: list[Author].
        """
        if results is None:
    ...
    @property
    def group_by(self):
        """Gets the group_by of this AuthorsList.
        :return: The group_by of this AuthorsList.
        :rtype: GroupByResult.
        """
    ...
    def group_by(self, group_by):
        """Sets the group_by of this AuthorsList.
        :param group_by: The group_by of this AuthorsList.
        :type: GroupByResult.
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(AuthorsList, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, AuthorsList):
            return False
