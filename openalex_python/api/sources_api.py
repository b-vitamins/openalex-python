...
class SourcesApi:
    ...
    def journals_get(self, **kwargs):
        """List journals (alias for sources)
        Alias endpoint for /sources
        ...
        if kwargs.get("async_req"):
            return self.journals_get_with_http_info(**kwargs)
        else:
            (data) = self.journals_get_with_http_info(**kwargs)
            return data

    def journals_get_with_http_info(self, **kwargs):
        """List journals (alias for sources)
        Alias endpoint for /sources
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.journals_get_with_http_info(async_req=True)
        >>> result = thread.get()
        :param async_req bool
        :param str api_key: API key for premium access. Grants higher API limits and enables special filters like from_updated_date.
        :param str cursor: Cursor for cursor-based pagination. Use cursor=* to start cursor pagination. Allows access to more than 10,000 results. Not compatible with sample parameter.
    ...
    def journals_id_get(self, id, **kwargs):
        """Get a single journal (alias for source)
        Alias endpoint for /sources/{id}
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.journals_id_get(id, async_req=True)
        >>> result = thread.get()
        :param async_req bool
        :param str id: The identifier for the source. Can be: - OpenAlex ID (e.g., S137773608) - ISSN (e.g., issn:2041-1723) - ISSN-L (e.g., issn_l:0028-0836) - Fatcat ID - Wikidata ID - Microsoft Academic Graph ID  (required)
        :param str select: Select only specific top-level fields to return. Use comma-separated field names. Example: id,display_name,cited_by_count  Cannot select nested fields. Does not work with group_by or autocomplete.
        :param str user_agent: User agent with email for polite pool access. Format: AppName/Version (mailto:email@example.com)  Polite pool provides faster and more reliable API access.
        :param str mailto: Email address for polite pool access. This allows for faster and more reliable API access.  Either this or the User-Agent header with mailto should be provided.
        :return: Source
        ...
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.journals_id_get_with_http_info(id, **kwargs)
        else:
            (data) = self.journals_id_get_with_http_info(id, **kwargs)
            return data

    def journals_id_get_with_http_info(self, id, **kwargs):
        """Get a single journal (alias for source)
        Alias endpoint for /sources/{id}
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.journals_id_get_with_http_info(id, async_req=True)
        >>> result = thread.get()
        :param async_req bool
        :param str id: The identifier for the source. Can be: - OpenAlex ID (e.g., S137773608) - ISSN (e.g., issn:2041-1723) - ISSN-L (e.g., issn_l:0028-0836) - Fatcat ID - Wikidata ID - Microsoft Academic Graph ID  (required)
        :param str select: Select only specific top-level fields to return. Use comma-separated field names. Example: id,display_name,cited_by_count  Cannot select nested fields. Does not work with group_by or autocomplete.
        ...
        for key, val in six.iteritems(params["kwargs"]):
            if key not in all_params:
                raise TypeError(
                    f"Got an unexpected keyword argument '{key}'"
                    " to method journals_id_get"
                )
            params[key] = val
        del params["kwargs"]
        if "id" not in params or params["id"] is None:
            raise ValueError(
                "Missing the required parameter `id` when calling `journals_id_get`"
            )
        collection_formats = {}
        path_params = {}
        if "id" in params:
    ...
    def sources_get(self, **kwargs):
        """List sources
        Get a paginated list of sources with optional filtering, searching, and sorting. Sources include journals, conferences, preprint repositories, and institutional repositories.  Also available via alias: /journals
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def sources_id_get(self, id, **kwargs):
        """Get a single source
        Get details for a single source by its identifier.  Supported ID formats: - OpenAlex ID (e.g., S137773608 or https://openalex.org/S137773608) - ISSN (e.g., issn:2041-1723) - ISSN-L (e.g., issn_l:0028-0836) - Fatcat ID (e.g., fatcat:zzzzz) - Wikidata ID (e.g., wikidata:Q180445) - Microsoft Academic Graph ID (e.g., mag:137773608)
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.sources_id_get(id, async_req=True)
        >>> result = thread.get()
        :param async_req bool
        :param str id: The identifier for the source. Can be: - OpenAlex ID (e.g., S137773608) - ISSN (e.g., issn:2041-1723) - ISSN-L (e.g., issn_l:0028-0836) - Fatcat ID - Wikidata ID - Microsoft Academic Graph ID  (required)
        :param str select: Select only specific top-level fields to return. Use comma-separated field names. Example: id,display_name,cited_by_count  Cannot select nested fields. Does not work with group_by or autocomplete.
        ...
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.sources_id_get_with_http_info(id, **kwargs)
        else:
            (data) = self.sources_id_get_with_http_info(id, **kwargs)
            return data

    def sources_id_get_with_http_info(self, id, **kwargs):
        """Get a single source
        Get details for a single source by its identifier.  Supported ID formats: - OpenAlex ID (e.g., S137773608 or https://openalex.org/S137773608) - ISSN (e.g., issn:2041-1723) - ISSN-L (e.g., issn_l:0028-0836) - Fatcat ID (e.g., fatcat:zzzzz) - Wikidata ID (e.g., wikidata:Q180445) - Microsoft Academic Graph ID (e.g., mag:137773608)
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.sources_id_get_with_http_info(id, async_req=True)
        >>> result = thread.get()
        :param async_req bool
        :param str id: The identifier for the source. Can be: - OpenAlex ID (e.g., S137773608) - ISSN (e.g., issn:2041-1723) - ISSN-L (e.g., issn_l:0028-0836) - Fatcat ID - Wikidata ID - Microsoft Academic Graph ID  (required)
        :param str select: Select only specific top-level fields to return. Use comma-separated field names. Example: id,display_name,cited_by_count  Cannot select nested fields. Does not work with group_by or autocomplete.
        ...
        for key, val in six.iteritems(params["kwargs"]):
            if key not in all_params:
                raise TypeError(
                    f"Got an unexpected keyword argument '{key}'"
                    " to method sources_id_get"
                )
            params[key] = val
        del params["kwargs"]
        if "id" not in params or params["id"] is None:
            raise ValueError(
                "Missing the required parameter `id` when calling `sources_id_get`"
            )
        collection_formats = {}
        path_params = {}
        if "id" in params:
    ...
    def sources_random_get(self, **kwargs):
        """Get a random source
        Returns a random source from the catalog
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.sources_random_get(async_req=True)
        >>> result = thread.get()
        :param async_req bool
        :param str select: Select only specific top-level fields to return. Use comma-separated field names. Example: id,display_name,cited_by_count  Cannot select nested fields. Does not work with group_by or autocomplete.
        :param str user_agent: User agent with email for polite pool access. Format: AppName/Version (mailto:email@example.com)  Polite pool provides faster and more reliable API access.
        ...
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.sources_random_get_with_http_info(**kwargs)
        else:
            (data) = self.sources_random_get_with_http_info(**kwargs)
            return data

    def sources_random_get_with_http_info(self, **kwargs):
        """Get a random source
        Returns a random source from the catalog
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.sources_random_get_with_http_info(async_req=True)
        >>> result = thread.get()
        :param async_req bool
        :param str select: Select only specific top-level fields to return. Use comma-separated field names. Example: id,display_name,cited_by_count  Cannot select nested fields. Does not work with group_by or autocomplete.
        :param str user_agent: User agent with email for polite pool access. Format: AppName/Version (mailto:email@example.com)  Polite pool provides faster and more reliable API access.
