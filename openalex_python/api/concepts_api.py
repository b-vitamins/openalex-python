...
class ConceptsApi:
    ...
    def concepts_get(self, **kwargs):
        """List concepts
        Get a paginated list of concepts.   Note: Concepts are deprecated in favor of Topics. We will continue to provide Concepts for Works, but we will not be actively maintaining, updating, or providing support for these concepts.
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.concepts_get(async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get("async_req"):
            return self.concepts_get_with_http_info(**kwargs)
        else:
            (data) = self.concepts_get_with_http_info(**kwargs)
            return data

    def concepts_get_with_http_info(self, **kwargs):
        """List concepts
        Get a paginated list of concepts.   Note: Concepts are deprecated in favor of Topics. We will continue to provide Concepts for Works, but we will not be actively maintaining, updating, or providing support for these concepts.
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.concepts_get_with_http_info(async_req=True)
        >>> result = thread.get()
        :param async_req bool
        :param str api_key: API key for premium access. Grants higher API limits and enables special filters like from_updated_date.
        :param str cursor: Cursor for cursor-based pagination. Use cursor=* to start cursor pagination. Allows access to more than 10,000 results. Not compatible with sample parameter.
    ...
    def concepts_id_get(self, id, **kwargs):
        """Get a single concept
        Get details for a single concept by its identifier.  Supported ID formats: - OpenAlex ID (e.g., C71924100 or https://openalex.org/C71924100) - Wikidata ID (e.g., wikidata:Q11190) - Microsoft Academic Graph ID (e.g., mag:71924100)  Note: Concepts are deprecated in favor of Topics.
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.concepts_id_get(id, async_req=True)
        >>> result = thread.get()
        :param async_req bool
        :param str id: The identifier for the concept. Can be: - OpenAlex ID (e.g., C71924100) - Wikidata ID (e.g., wikidata:Q11190) - Microsoft Academic Graph ID  (required)
        :param str select: Select only specific top-level fields to return. Use comma-separated field names. Example: id,display_name,cited_by_count  Cannot select nested fields. Does not work with group_by or autocomplete.
        :param str user_agent: User agent with email for polite pool access. Format: AppName/Version (mailto:email@example.com)  Polite pool provides faster and more reliable API access.
        :param str mailto: Email address for polite pool access. This allows for faster and more reliable API access.  Either this or the User-Agent header with mailto should be provided.
        :return: Concept
        ...
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.concepts_id_get_with_http_info(id, **kwargs)
        else:
            (data) = self.concepts_id_get_with_http_info(id, **kwargs)
            return data

    def concepts_id_get_with_http_info(self, id, **kwargs):
        """Get a single concept
        Get details for a single concept by its identifier.  Supported ID formats: - OpenAlex ID (e.g., C71924100 or https://openalex.org/C71924100) - Wikidata ID (e.g., wikidata:Q11190) - Microsoft Academic Graph ID (e.g., mag:71924100)  Note: Concepts are deprecated in favor of Topics.
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.concepts_id_get_with_http_info(id, async_req=True)
        >>> result = thread.get()
        :param async_req bool
        :param str id: The identifier for the concept. Can be: - OpenAlex ID (e.g., C71924100) - Wikidata ID (e.g., wikidata:Q11190) - Microsoft Academic Graph ID  (required)
        :param str select: Select only specific top-level fields to return. Use comma-separated field names. Example: id,display_name,cited_by_count  Cannot select nested fields. Does not work with group_by or autocomplete.
        ...
        for key, val in six.iteritems(params["kwargs"]):
            if key not in all_params:
                raise TypeError(
                    f"Got an unexpected keyword argument '{key}'"
                    " to method concepts_id_get"
                )
            params[key] = val
        del params["kwargs"]
        if "id" not in params or params["id"] is None:
            raise ValueError(
                "Missing the required parameter `id` when calling `concepts_id_get`"
            )
        collection_formats = {}
        path_params = {}
        if "id" in params:
    ...
    def concepts_random_get(self, **kwargs):
        """Get a random concept
        Returns a random concept from the catalog.  Note: Concepts are deprecated in favor of Topics.
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.concepts_random_get(async_req=True)
        >>> result = thread.get()
        :param async_req bool
        :param str select: Select only specific top-level fields to return. Use comma-separated field names. Example: id,display_name,cited_by_count  Cannot select nested fields. Does not work with group_by or autocomplete.
        :param str user_agent: User agent with email for polite pool access. Format: AppName/Version (mailto:email@example.com)  Polite pool provides faster and more reliable API access.
        ...
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.concepts_random_get_with_http_info(**kwargs)
        else:
            (data) = self.concepts_random_get_with_http_info(**kwargs)
            return data

    def concepts_random_get_with_http_info(self, **kwargs):
        """Get a random concept
        Returns a random concept from the catalog.  Note: Concepts are deprecated in favor of Topics.
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.concepts_random_get_with_http_info(async_req=True)
        >>> result = thread.get()
        :param async_req bool
        :param str select: Select only specific top-level fields to return. Use comma-separated field names. Example: id,display_name,cited_by_count  Cannot select nested fields. Does not work with group_by or autocomplete.
        :param str user_agent: User agent with email for polite pool access. Format: AppName/Version (mailto:email@example.com)  Polite pool provides faster and more reliable API access.
