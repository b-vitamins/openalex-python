...
class KeywordsApi:
    ...
    def keywords_get(self, **kwargs):
        """List keywords
        Get a paginated list of keywords with optional filtering and sorting. Keywords are short words or phrases assigned to works using AI.
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.keywords_get(async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get("async_req"):
            return self.keywords_get_with_http_info(**kwargs)
        else:
            (data) = self.keywords_get_with_http_info(**kwargs)
            return data

    def keywords_get_with_http_info(self, **kwargs):
        """List keywords
        Get a paginated list of keywords with optional filtering and sorting. Keywords are short words or phrases assigned to works using AI.
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.keywords_get_with_http_info(async_req=True)
        >>> result = thread.get()
        :param async_req bool
        :param str api_key: API key for premium access. Grants higher API limits and enables special filters like from_updated_date.
        :param str cursor: Cursor for cursor-based pagination. Use cursor=* to start cursor pagination. Allows access to more than 10,000 results. Not compatible with sample parameter.
    ...
    def keywords_id_get(self, id, **kwargs):
        """Get a single keyword
        Get details for a single keyword by its identifier.  Example ID: cardiac-imaging
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.keywords_id_get(id, async_req=True)
        >>> result = thread.get()
        :param async_req bool
        :param str id: The identifier for the keyword (e.g., cardiac-imaging) (required)
        :param str select: Select only specific top-level fields to return. Use comma-separated field names. Example: id,display_name,cited_by_count  Cannot select nested fields. Does not work with group_by or autocomplete.
        :param str user_agent: User agent with email for polite pool access. Format: AppName/Version (mailto:email@example.com)  Polite pool provides faster and more reliable API access.
        :param str mailto: Email address for polite pool access. This allows for faster and more reliable API access.  Either this or the User-Agent header with mailto should be provided.
        :return: Keyword
        ...
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.keywords_id_get_with_http_info(id, **kwargs)
        else:
            (data) = self.keywords_id_get_with_http_info(id, **kwargs)
            return data

    def keywords_id_get_with_http_info(self, id, **kwargs):
        """Get a single keyword
        Get details for a single keyword by its identifier.  Example ID: cardiac-imaging
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.keywords_id_get_with_http_info(id, async_req=True)
        >>> result = thread.get()
        :param async_req bool
        :param str id: The identifier for the keyword (e.g., cardiac-imaging) (required)
        :param str select: Select only specific top-level fields to return. Use comma-separated field names. Example: id,display_name,cited_by_count  Cannot select nested fields. Does not work with group_by or autocomplete.
        ...
        for key, val in six.iteritems(params["kwargs"]):
            if key not in all_params:
                raise TypeError(
                    f"Got an unexpected keyword argument '{key}'"
                    " to method keywords_id_get"
                )
            params[key] = val
        del params["kwargs"]
        if "id" not in params or params["id"] is None:
            raise ValueError(
                "Missing the required parameter `id` when calling `keywords_id_get`"
            )
        collection_formats = {}
        path_params = {}
        if "id" in params:
