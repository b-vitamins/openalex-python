...
class InstitutionsApi:
    ...
    def institutions_get(self, **kwargs):
        """List institutions
        Get a paginated list of institutions with optional filtering, searching, and sorting. Institutions are universities and other organizations to which authors claim affiliations.
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.institutions_get(async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get("async_req"):
            return self.institutions_get_with_http_info(**kwargs)
        else:
            (data) = self.institutions_get_with_http_info(**kwargs)
            return data

    def institutions_get_with_http_info(self, **kwargs):
        """List institutions
        Get a paginated list of institutions with optional filtering, searching, and sorting. Institutions are universities and other organizations to which authors claim affiliations.
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.institutions_get_with_http_info(async_req=True)
        >>> result = thread.get()
        :param async_req bool
        :param str api_key: API key for premium access. Grants higher API limits and enables special filters like from_updated_date.
        :param str cursor: Cursor for cursor-based pagination. Use cursor=* to start cursor pagination. Allows access to more than 10,000 results. Not compatible with sample parameter.
        ...
        return self.api_client.call_api(
            ...
            response_type="InstitutionsList",
    ...
    def institutions_id_get(self, id, **kwargs):
        """Get a single institution
        Get details for a single institution by its identifier.  Supported ID formats: - OpenAlex ID (e.g., I27837315 or https://openalex.org/I27837315) - ROR ID (e.g., https://ror.org/00jmfr291 or ror:00jmfr291) - Microsoft Academic Graph ID (e.g., mag:114027177) - Wikidata ID (e.g., wikidata:Q192334)
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.institutions_id_get(id, async_req=True)
        >>> result = thread.get()
        :param async_req bool
        :param str id: The identifier for the institution. Can be: - OpenAlex ID (e.g., I27837315) - ROR ID (e.g., https://ror.org/00jmfr291 or ror:00jmfr291) - Microsoft Academic Graph ID - Wikidata ID  (required)
        :param str select: Select only specific top-level fields to return. Use comma-separated field names. Example: id,display_name,cited_by_count  Cannot select nested fields. Does not work with group_by or autocomplete.
        :param str user_agent: User agent with email for polite pool access. Format: AppName/Version (mailto:email@example.com)  Polite pool provides faster and more reliable API access.
        :param str mailto: Email address for polite pool access. This allows for faster and more reliable API access.  Either this or the User-Agent header with mailto should be provided.
        :return: Institution
        ...
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.institutions_id_get_with_http_info(id, **kwargs)
        else:
            (data) = self.institutions_id_get_with_http_info(id, **kwargs)
            return data

    def institutions_id_get_with_http_info(self, id, **kwargs):
        """Get a single institution
        Get details for a single institution by its identifier.  Supported ID formats: - OpenAlex ID (e.g., I27837315 or https://openalex.org/I27837315) - ROR ID (e.g., https://ror.org/00jmfr291 or ror:00jmfr291) - Microsoft Academic Graph ID (e.g., mag:114027177) - Wikidata ID (e.g., wikidata:Q192334)
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.institutions_id_get_with_http_info(id, async_req=True)
        >>> result = thread.get()
        :param async_req bool
        :param str id: The identifier for the institution. Can be: - OpenAlex ID (e.g., I27837315) - ROR ID (e.g., https://ror.org/00jmfr291 or ror:00jmfr291) - Microsoft Academic Graph ID - Wikidata ID  (required)
        :param str select: Select only specific top-level fields to return. Use comma-separated field names. Example: id,display_name,cited_by_count  Cannot select nested fields. Does not work with group_by or autocomplete.
        ...
        for key, val in six.iteritems(params["kwargs"]):
            if key not in all_params:
                raise TypeError(
                    f"Got an unexpected keyword argument '{key}'"
                    " to method institutions_id_get"
                )
            params[key] = val
        del params["kwargs"]
        if "id" not in params or params["id"] is None:
            raise ValueError(
                "Missing the required parameter `id` when calling `institutions_id_get`"
            )
        collection_formats = {}
        path_params = {}
        if "id" in params:
    ...
    def institutions_random_get(self, **kwargs):
        """Get a random institution
        Returns a random institution from the catalog
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.institutions_random_get(async_req=True)
        >>> result = thread.get()
        :param async_req bool
        :param str select: Select only specific top-level fields to return. Use comma-separated field names. Example: id,display_name,cited_by_count  Cannot select nested fields. Does not work with group_by or autocomplete.
        :param str user_agent: User agent with email for polite pool access. Format: AppName/Version (mailto:email@example.com)  Polite pool provides faster and more reliable API access.
        ...
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.institutions_random_get_with_http_info(**kwargs)
        else:
            (data) = self.institutions_random_get_with_http_info(**kwargs)
            return data

    def institutions_random_get_with_http_info(self, **kwargs):
        """Get a random institution
        Returns a random institution from the catalog
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.institutions_random_get_with_http_info(async_req=True)
        >>> result = thread.get()
        :param async_req bool
        :param str select: Select only specific top-level fields to return. Use comma-separated field names. Example: id,display_name,cited_by_count  Cannot select nested fields. Does not work with group_by or autocomplete.
        :param str user_agent: User agent with email for polite pool access. Format: AppName/Version (mailto:email@example.com)  Polite pool provides faster and more reliable API access.
        ...
        for key, val in six.iteritems(params["kwargs"]):
            if key not in all_params:
                raise TypeError(
                    f"Got an unexpected keyword argument '{key}'"
                    " to method institutions_random_get"
                )
            params[key] = val
        del params["kwargs"]
        collection_formats = {}
