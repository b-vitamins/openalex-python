...
class PublishersApi:
    ...
    def publishers_get(self, **kwargs):
        """List publishers
        Get a paginated list of publishers with optional filtering, searching, and sorting. Publishers are companies and organizations that distribute journal articles, books, and theses.
        ...
        if kwargs.get("async_req"):
            return self.publishers_get_with_http_info(**kwargs)
        else:
            (data) = self.publishers_get_with_http_info(**kwargs)
            return data

    def publishers_get_with_http_info(self, **kwargs):
        """List publishers
        Get a paginated list of publishers with optional filtering, searching, and sorting. Publishers are companies and organizations that distribute journal articles, books, and theses.
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def publishers_id_get(self, id, **kwargs):
        """Get a single publisher
        Get details for a single publisher by its identifier.  Supported ID formats: - OpenAlex ID (e.g., P4310319965 or https://openalex.org/P4310319965) - ROR ID (e.g., ror:02scfj030) - Wikidata ID (e.g., wikidata:Q746413)
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.publishers_id_get(id, async_req=True)
        >>> result = thread.get()
        :param async_req bool
        :param str id: The identifier for the publisher. Can be: - OpenAlex ID (e.g., P4310319965) - ROR ID - Wikidata ID  (required)
        :param str select: Select only specific top-level fields to return. Use comma-separated field names. Example: id,display_name,cited_by_count  Cannot select nested fields. Does not work with group_by or autocomplete.
        :param str user_agent: User agent with email for polite pool access. Format: AppName/Version (mailto:email@example.com)  Polite pool provides faster and more reliable API access.
        :param str mailto: Email address for polite pool access. This allows for faster and more reliable API access.  Either this or the User-Agent header with mailto should be provided.
        :return: Publisher
        ...
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.publishers_id_get_with_http_info(id, **kwargs)
        else:
            (data) = self.publishers_id_get_with_http_info(id, **kwargs)
            return data

    def publishers_id_get_with_http_info(self, id, **kwargs):
        """Get a single publisher
        Get details for a single publisher by its identifier.  Supported ID formats: - OpenAlex ID (e.g., P4310319965 or https://openalex.org/P4310319965) - ROR ID (e.g., ror:02scfj030) - Wikidata ID (e.g., wikidata:Q746413)
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        for key, val in six.iteritems(params["kwargs"]):
            if key not in all_params:
                raise TypeError(
                    f"Got an unexpected keyword argument '{key}'"
                    " to method publishers_id_get"
                )
            params[key] = val
        del params["kwargs"]
        if "id" not in params or params["id"] is None:
            raise ValueError(
                "Missing the required parameter `id` when calling `publishers_id_get`"
            )
        collection_formats = {}
        path_params = {}
        if "id" in params:
    ...
    def publishers_random_get(self, **kwargs):
        """Get a random publisher
        Returns a random publisher from the catalog
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.publishers_random_get(async_req=True)
        >>> result = thread.get()
        :param async_req bool
        :param str select: Select only specific top-level fields to return. Use comma-separated field names. Example: id,display_name,cited_by_count  Cannot select nested fields. Does not work with group_by or autocomplete.
        :param str user_agent: User agent with email for polite pool access. Format: AppName/Version (mailto:email@example.com)  Polite pool provides faster and more reliable API access.
        ...
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.publishers_random_get_with_http_info(**kwargs)
        else:
            (data) = self.publishers_random_get_with_http_info(**kwargs)
            return data

    def publishers_random_get_with_http_info(self, **kwargs):
        """Get a random publisher
        Returns a random publisher from the catalog
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.publishers_random_get_with_http_info(async_req=True)
        >>> result = thread.get()
        :param async_req bool
        :param str select: Select only specific top-level fields to return. Use comma-separated field names. Example: id,display_name,cited_by_count  Cannot select nested fields. Does not work with group_by or autocomplete.
        :param str user_agent: User agent with email for polite pool access. Format: AppName/Version (mailto:email@example.com)  Polite pool provides faster and more reliable API access.
        ...
        for key, val in six.iteritems(params["kwargs"]):
            if key not in all_params:
                raise TypeError(
                    f"Got an unexpected keyword argument '{key}'"
                    " to method publishers_random_get"
                )
            params[key] = val
        del params["kwargs"]
        collection_formats = {}
