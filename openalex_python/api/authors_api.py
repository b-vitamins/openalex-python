...
class AuthorsApi:
    ...
    def authors_get(self, **kwargs):
        """List authors
        Get a paginated list of authors with optional filtering, searching, and sorting.  Also available via alias: /people
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.authors_get(async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get("async_req"):
            return self.authors_get_with_http_info(**kwargs)
        else:
            (data) = self.authors_get_with_http_info(**kwargs)
            return data

    def authors_get_with_http_info(self, **kwargs):
        """List authors
        Get a paginated list of authors with optional filtering, searching, and sorting.  Also available via alias: /people
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.authors_get_with_http_info(async_req=True)
        >>> result = thread.get()
        :param async_req bool
        :param str api_key: API key for premium access. Grants higher API limits and enables special filters like from_updated_date.
        :param str cursor: Cursor for cursor-based pagination. Use cursor=* to start cursor pagination. Allows access to more than 10,000 results. Not compatible with sample parameter.
    ...
    def authors_id_get(self, id, **kwargs):
        """Get a single author
        Get details for a single author by their identifier.  Supported ID formats: - OpenAlex ID (e.g., A5023888391 or https://openalex.org/A5023888391) - ORCID (e.g., https://orcid.org/0000-0001-6187-6610 or orcid:0000-0001-6187-6610) - Scopus ID (e.g., scopus:36455008000) - Twitter handle (e.g., twitter:jasonpriem) - Wikipedia URL
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.authors_id_get(id, async_req=True)
        >>> result = thread.get()
        :param async_req bool
        :param str id: The identifier for the author. Can be: - OpenAlex ID (e.g., A5023888391 or https://openalex.org/A5023888391) - ORCID (e.g., https://orcid.org/0000-0001-6187-6610 or orcid:0000-0001-6187-6610) - Scopus ID (e.g., scopus:36455008000) - Twitter handle (e.g., twitter:jasonpriem) - Wikipedia URL  (required)
        :param str select: Select only specific top-level fields to return. Use comma-separated field names. Example: id,display_name,cited_by_count  Cannot select nested fields. Does not work with group_by or autocomplete.
        :param str user_agent: User agent with email for polite pool access. Format: AppName/Version (mailto:email@example.com)  Polite pool provides faster and more reliable API access.
        :param str mailto: Email address for polite pool access. This allows for faster and more reliable API access.  Either this or the User-Agent header with mailto should be provided.
        :return: Author
        ...
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.authors_id_get_with_http_info(id, **kwargs)
        else:
            (data) = self.authors_id_get_with_http_info(id, **kwargs)
            return data

    def authors_id_get_with_http_info(self, id, **kwargs):
        """Get a single author
        Get details for a single author by their identifier.  Supported ID formats: - OpenAlex ID (e.g., A5023888391 or https://openalex.org/A5023888391) - ORCID (e.g., https://orcid.org/0000-0001-6187-6610 or orcid:0000-0001-6187-6610) - Scopus ID (e.g., scopus:36455008000) - Twitter handle (e.g., twitter:jasonpriem) - Wikipedia URL
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.authors_id_get_with_http_info(id, async_req=True)
        >>> result = thread.get()
        :param async_req bool
        :param str id: The identifier for the author. Can be: - OpenAlex ID (e.g., A5023888391 or https://openalex.org/A5023888391) - ORCID (e.g., https://orcid.org/0000-0001-6187-6610 or orcid:0000-0001-6187-6610) - Scopus ID (e.g., scopus:36455008000) - Twitter handle (e.g., twitter:jasonpriem) - Wikipedia URL  (required)
        :param str select: Select only specific top-level fields to return. Use comma-separated field names. Example: id,display_name,cited_by_count  Cannot select nested fields. Does not work with group_by or autocomplete.
        ...
        for key, val in six.iteritems(params["kwargs"]):
            if key not in all_params:
                raise TypeError(
                    f"Got an unexpected keyword argument '{key}'"
                    " to method authors_id_get"
                )
            params[key] = val
        del params["kwargs"]
        if "id" not in params or params["id"] is None:
            raise ValueError(
                "Missing the required parameter `id` when calling `authors_id_get`"
            )
        collection_formats = {}
        path_params = {}
        if "id" in params:
    ...
    def authors_random_get(self, **kwargs):
        """Get a random author
        Returns a random author from the catalog
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.authors_random_get(async_req=True)
        >>> result = thread.get()
        :param async_req bool
        :param str select: Select only specific top-level fields to return. Use comma-separated field names. Example: id,display_name,cited_by_count  Cannot select nested fields. Does not work with group_by or autocomplete.
        :param str user_agent: User agent with email for polite pool access. Format: AppName/Version (mailto:email@example.com)  Polite pool provides faster and more reliable API access.
        ...
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.authors_random_get_with_http_info(**kwargs)
        else:
            (data) = self.authors_random_get_with_http_info(**kwargs)
            return data

    def authors_random_get_with_http_info(self, **kwargs):
        """Get a random author
        Returns a random author from the catalog
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.authors_random_get_with_http_info(async_req=True)
        >>> result = thread.get()
        :param async_req bool
        :param str select: Select only specific top-level fields to return. Use comma-separated field names. Example: id,display_name,cited_by_count  Cannot select nested fields. Does not work with group_by or autocomplete.
        :param str user_agent: User agent with email for polite pool access. Format: AppName/Version (mailto:email@example.com)  Polite pool provides faster and more reliable API access.
    ...
    def people_get(self, **kwargs):
        """List people (alias for authors)
        Alias endpoint for /authors
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.people_get_with_http_info(**kwargs)
        else:
            (data) = self.people_get_with_http_info(**kwargs)
            return data

    def people_get_with_http_info(self, **kwargs):
        """List people (alias for authors)
        Alias endpoint for /authors
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        for key, val in six.iteritems(params["kwargs"]):
            if key not in all_params:
                raise TypeError(
                    f"Got an unexpected keyword argument '{key}' to method people_get"
                )
            params[key] = val
        del params["kwargs"]
        collection_formats = {}
    ...
    def people_id_get(self, id, **kwargs):
        """Get a single person (alias for author)
        Alias endpoint for /authors/{id}
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.people_id_get(id, async_req=True)
        >>> result = thread.get()
        :param async_req bool
        :param str id: The identifier for the author. Can be: - OpenAlex ID (e.g., A5023888391 or https://openalex.org/A5023888391) - ORCID (e.g., https://orcid.org/0000-0001-6187-6610 or orcid:0000-0001-6187-6610) - Scopus ID (e.g., scopus:36455008000) - Twitter handle (e.g., twitter:jasonpriem) - Wikipedia URL  (required)
        :param str select: Select only specific top-level fields to return. Use comma-separated field names. Example: id,display_name,cited_by_count  Cannot select nested fields. Does not work with group_by or autocomplete.
        ...
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.people_id_get_with_http_info(id, **kwargs)
        else:
            (data) = self.people_id_get_with_http_info(id, **kwargs)
            return data

    def people_id_get_with_http_info(self, id, **kwargs):
        """Get a single person (alias for author)
        Alias endpoint for /authors/{id}
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.people_id_get_with_http_info(id, async_req=True)
        >>> result = thread.get()
        :param async_req bool
        :param str id: The identifier for the author. Can be: - OpenAlex ID (e.g., A5023888391 or https://openalex.org/A5023888391) - ORCID (e.g., https://orcid.org/0000-0001-6187-6610 or orcid:0000-0001-6187-6610) - Scopus ID (e.g., scopus:36455008000) - Twitter handle (e.g., twitter:jasonpriem) - Wikipedia URL  (required)
        :param str select: Select only specific top-level fields to return. Use comma-separated field names. Example: id,display_name,cited_by_count  Cannot select nested fields. Does not work with group_by or autocomplete.
        ...
        for key, val in six.iteritems(params["kwargs"]):
            if key not in all_params:
                raise TypeError(
                    f"Got an unexpected keyword argument '{key}'"
                    " to method people_id_get"
                )
            params[key] = val
        del params["kwargs"]
        if "id" not in params or params["id"] is None:
            raise ValueError(
                "Missing the required parameter `id` when calling `people_id_get`"
            )
        collection_formats = {}
        path_params = {}
        if "id" in params:
