...
class TopicsApi:
    ...
    def topics_get(self, **kwargs):
        """List topics
        Get a paginated list of topics with optional filtering, searching, and sorting. Topics are assigned to works using an automated system based on title, abstract, and citations.
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.topics_get(async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get("async_req"):
            return self.topics_get_with_http_info(**kwargs)
        else:
            (data) = self.topics_get_with_http_info(**kwargs)
            return data

    def topics_get_with_http_info(self, **kwargs):
        """List topics
        Get a paginated list of topics with optional filtering, searching, and sorting. Topics are assigned to works using an automated system based on title, abstract, and citations.
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.topics_get_with_http_info(async_req=True)
        >>> result = thread.get()
        :param async_req bool
        :param str api_key: API key for premium access. Grants higher API limits and enables special filters like from_updated_date.
        :param str cursor: Cursor for cursor-based pagination. Use cursor=* to start cursor pagination. Allows access to more than 10,000 results. Not compatible with sample parameter.
        ...
        for key, val in six.iteritems(params["kwargs"]):
            if key not in all_params:
                raise TypeError(
                    f"Got an unexpected keyword argument '{key}' to method topics_get"
                )
            params[key] = val
        del params["kwargs"]
        collection_formats = {}
    ...
    def topics_id_get(self, id, **kwargs):
        """Get a single topic
        Get details for a single topic by its identifier
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.topics_id_get(id, async_req=True)
        >>> result = thread.get()
        :param async_req bool
        :param str id: The OpenAlex ID for the topic (e.g., T11636) (required)
        :param str select: Select only specific top-level fields to return. Use comma-separated field names. Example: id,display_name,cited_by_count  Cannot select nested fields. Does not work with group_by or autocomplete.
        :param str user_agent: User agent with email for polite pool access. Format: AppName/Version (mailto:email@example.com)  Polite pool provides faster and more reliable API access.
        :param str mailto: Email address for polite pool access. This allows for faster and more reliable API access.  Either this or the User-Agent header with mailto should be provided.
        :return: Topic
        ...
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.topics_id_get_with_http_info(id, **kwargs)
        else:
            (data) = self.topics_id_get_with_http_info(id, **kwargs)
            return data

    def topics_id_get_with_http_info(self, id, **kwargs):
        """Get a single topic
        Get details for a single topic by its identifier
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.topics_id_get_with_http_info(id, async_req=True)
        >>> result = thread.get()
        :param async_req bool
        :param str id: The OpenAlex ID for the topic (e.g., T11636) (required)
        :param str select: Select only specific top-level fields to return. Use comma-separated field names. Example: id,display_name,cited_by_count  Cannot select nested fields. Does not work with group_by or autocomplete.
        ...
        for key, val in six.iteritems(params["kwargs"]):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method topics_id_get"
                )
            params[key] = val
        del params["kwargs"]
        if "id" not in params or params["id"] is None:
            raise ValueError(
                "Missing the required parameter `id` when calling `topics_id_get`"
            )
        collection_formats = {}
        path_params = {}
        if "id" in params:
    ...
    def topics_random_get(self, **kwargs):
        """Get a random topic
        Returns a random topic from the catalog
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.topics_random_get(async_req=True)
        >>> result = thread.get()
        :param async_req bool
        :param str select: Select only specific top-level fields to return. Use comma-separated field names. Example: id,display_name,cited_by_count  Cannot select nested fields. Does not work with group_by or autocomplete.
        :param str user_agent: User agent with email for polite pool access. Format: AppName/Version (mailto:email@example.com)  Polite pool provides faster and more reliable API access.
        ...
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.topics_random_get_with_http_info(**kwargs)
        else:
            (data) = self.topics_random_get_with_http_info(**kwargs)
            return data

    def topics_random_get_with_http_info(self, **kwargs):
        """Get a random topic
        Returns a random topic from the catalog
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.topics_random_get_with_http_info(async_req=True)
        >>> result = thread.get()
        :param async_req bool
        :param str select: Select only specific top-level fields to return. Use comma-separated field names. Example: id,display_name,cited_by_count  Cannot select nested fields. Does not work with group_by or autocomplete.
        :param str user_agent: User agent with email for polite pool access. Format: AppName/Version (mailto:email@example.com)  Polite pool provides faster and more reliable API access.
