...
class TestWorkCitationNormalizedPercentile(unittest.TestCase):
    """WorkCitationNormalizedPercentile unit test stubs"""
    ...
    def testWorkCitationNormalizedPercentile(self):
        """Test WorkCitationNormalizedPercentile"""
        pass
