...
class TestAllOfTextResultsConceptsItems(unittest.TestCase):
    """AllOfTextResultsConceptsItems unit test stubs"""
    ...
    def testAllOfTextResultsConceptsItems(self):
        """Test AllOfTextResultsConceptsItems"""
        pass
