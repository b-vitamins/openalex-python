...
class TestAuthorshipAffiliations(unittest.TestCase):
    """AuthorshipAffiliations unit test stubs"""
    ...
    def testAuthorshipAffiliations(self):
        """Test AuthorshipAffiliations"""
        pass
