...
class TestAllOfTextResultsTopicsItems(unittest.TestCase):
    """AllOfTextResultsTopicsItems unit test stubs"""
    ...
    def testAllOfTextResultsTopicsItems(self):
        """Test AllOfTextResultsTopicsItems"""
        pass
