...
class TestTextConceptsResultsMeta(unittest.TestCase):
    """TextConceptsResultsMeta unit test stubs"""
    ...
    def testTextConceptsResultsMeta(self):
        """Test TextConceptsResultsMeta"""
        pass
