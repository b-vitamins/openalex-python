...
class TestSourceModel:
    ...
    def test_source_basic_fields(self, mock_source_data):
        """Test that basic source fields are parsed correctly from fixture data."""
    ...
    def test_source_summary_stats(self, mock_source_data):
        """Test that source summary statistics are calculated correctly."""
        from openalex.models import Source
    ...
    def test_source_open_access_status(self, mock_source_data):
        """Test that open access status fields are properly parsed."""
        from openalex.models import Source
    ...
    def test_source_indexing(self, mock_source_data):
        """Test that indexing information is correctly structured."""
        from openalex.models import Source
    ...
    def test_source_ids_structure(self, mock_source_data):
        """Test that source IDs nested structure is properly parsed."""
        from openalex.models import Source
    ...
    def test_source_homepage_url(self, mock_source_data):
        """Test that homepage URL is correctly formatted."""
        from openalex.models import Source
    ...
    def test_source_apc_prices(self, mock_source_data):
        """Test that article processing charges are parsed correctly."""
        from openalex.models import Source
    ...
    def test_source_country_code(self, mock_source_data):
        """Test that country code is properly assigned."""
        from openalex.models import Source
    ...
    def test_source_societies(self, mock_source_data):
        """Test that affiliated societies are handled correctly."""
        from openalex.models import Source
    ...
    def test_source_alternate_titles(self, mock_source_data):
        """Test that alternate titles are properly structured."""
        from openalex.models import Source
    ...
    def test_source_abbreviated_title(self, mock_source_data):
        """Test that abbreviated title is handled when null."""
        from openalex.models import Source
    ...
    def test_source_topics(self, mock_source_data):
        """Test that source topics are correctly structured."""
        from openalex.models import Source
    ...
    def test_source_topic_share(self, mock_source_data):
        """Test that topic share percentages are calculated correctly."""
        from openalex.models import Source
    ...
    def test_source_x_concepts(self, mock_source_data):
        """Test that x_concepts legacy field is properly parsed."""
        from openalex.models import Source
    ...
    def test_source_counts_by_year(self, mock_source_data):
        """Test that yearly publication and citation counts are ordered correctly."""
        from openalex.models import Source
    ...
    def test_source_works_api_url(self, mock_source_data):
        """Test that works API URL is properly constructed."""
        from openalex.models import Source
    ...
    def test_source_updated_date(self, mock_source_data):
        """Test that updated date field is parsed correctly."""
        from openalex.models import Source
    ...
    def test_source_minimal_data(self):
        """Test that source model works with minimal required fields."""
        from openalex.models import Source
    ...
    def test_source_validation_errors(self):
        """Test that validation errors are raised for invalid source data."""
        from openalex.models import Source
    ...
    def test_open_access_journal(self):
        """Test that open access journal source is configured correctly."""
        from openalex.models import Source
    ...
    def test_repository_source(self):
        """Test that repository source type is handled correctly."""
        from openalex.models import Source
    ...
    def test_conference_source(self):
        """Test that conference source type is configured correctly."""
        from openalex.models import Source
    ...
    def test_source_with_multiple_issns(self):
        """Test that source with multiple ISSNs is handled correctly."""
        from openalex.models import Source
    ...
    def test_source_with_societies(self):
        """Test that source affiliated with academic societies is structured correctly."""
        from openalex.models import Source
    ...
    def test_source_complete_profile(self, mock_source_data):
        """Test that complete source profile has all expected fields populated."""
        from openalex.models import Source
