...
class TestAuthorModel:
    ...
    def test_author_summary_stats(self, mock_author_data):
        """Test that author summary statistics are accessible and computed correctly."""
        from openalex.models import Author
    ...
    def test_author_ids_structure(self, mock_author_data):
        """Test that author IDs nested structure is properly parsed."""
        from openalex.models import Author
    ...
    def test_author_affiliations(self, mock_author_data):
        """Test that author affiliations structure with years is correctly parsed."""
        from openalex.models import Author
    ...
    def test_author_last_known_institutions(self, mock_author_data):
        """Test that last known institutions are properly accessible."""
        from openalex.models import Author
    ...
    def test_author_topics(self, mock_author_data):
        """Test that author research topics are correctly structured."""
        from openalex.models import Author
    ...
    def test_author_counts_by_year(self, mock_author_data):
        """Test that yearly publication and citation counts are correctly ordered."""
        from openalex.models import Author
    ...
    def test_author_minimal_data(self):
        """Test that author model works with minimal required fields."""
        from openalex.models import Author
    ...
    def test_author_validation_errors(self):
        """Test that validation errors are raised for invalid author data."""
        from openalex.models import Author
    ...
    def test_author_with_multiple_affiliations(self):
        """Test that author with complex affiliation history is handled correctly."""
        from openalex.models import Author
    ...
    def test_author_without_orcid(self):
        """Test that author without ORCID handles missing data correctly."""
        from openalex.models import Author
    ...
    def test_author_name_alternatives(self, mock_author_data):
        """Test that display name alternatives are properly structured."""
        from openalex.models import Author
    ...
    def test_author_research_interests(self):
        """Test that author research interests are properly derived from topics."""
        from openalex.models import Author
    ...
    def test_author_metrics_edge_cases(self):
        """Test that author with zero or missing metrics is handled correctly."""
        from openalex.models import Author
    ...
    def test_author_complete_profile(self, mock_author_data):
        """Test that complete author profile has all expected fields populated."""
        from openalex.models import Author
