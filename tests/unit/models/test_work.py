...
class TestWorkModel:
    ...
    def test_work_basic_fields(self, mock_work_data):
        """Test that basic work fields are parsed correctly from fixture data."""
    ...
    def test_work_ids_structure(self, mock_work_data):
        """Test that work IDs nested structure is properly parsed."""
        from openalex.models import Work
    ...
    def test_work_primary_location(self, mock_work_data):
        """Test that primary location structure is correctly parsed."""
        from openalex.models import Work
    ...
    def test_work_open_access(self, mock_work_data):
        """Test that open access information is properly structured."""
        from openalex.models import Work
    ...
    def test_work_authorships(self, mock_work_data):
        """Test that authorship structure includes all required details."""
        from openalex.models import Work
    ...
    def test_work_topics(self, mock_work_data):
        """Test that topics and subtopics are correctly structured."""
        from openalex.models import Work
    ...
    def test_work_keywords(self, mock_work_data):
        """Test that keywords structure is properly parsed."""
        from openalex.models import Work
    ...
    def test_work_concepts(self, mock_work_data):
        """Test that concepts structure is correctly handled."""
        from openalex.models import Work
    ...
    def test_work_mesh_terms(self, mock_work_data):
        """Test that MeSH terms are handled when empty."""
        from openalex.models import Work
    ...
    def test_work_locations_count(self, mock_work_data):
        """Test that multiple locations are counted correctly."""
        from openalex.models import Work
    ...
    def test_work_best_oa_location(self, mock_work_data):
        """Test that best open access location is selected correctly."""
        from openalex.models import Work
    ...
    def test_work_referenced_works(self, mock_work_data):
        """Test that referenced works are properly structured."""
        from openalex.models import Work
    ...
    def test_work_related_works(self, mock_work_data):
        """Test that related works are properly formatted."""
        from openalex.models import Work
    ...
    def test_work_abstract(self, mock_work_data):
        """Test that abstract is reconstructed from inverted index correctly."""
        from openalex.models import Work
    ...
    def test_work_biblio(self, mock_work_data):
        """Test that bibliographic information is parsed correctly."""
        from openalex.models import Work
    ...
    def test_work_sustainable_development_goals(self, mock_work_data):
        """Test that sustainable development goals are handled when empty."""
        from openalex.models import Work
    ...
    def test_work_grants(self, mock_work_data):
        """Test that grants information is properly structured."""
        from openalex.models import Work
    ...
    def test_work_apc(self, mock_work_data):
        """Test that article processing charges are calculated correctly."""
        from openalex.models import Work
    ...
    def test_work_counts_by_year(self, mock_work_data):
        """Test that citation counts by year are ordered correctly."""
        from openalex.models import Work
    ...
    def test_work_citation_normalized_percentile(self, mock_work_data):
        """Test that citation percentile metrics are calculated correctly."""
        from openalex.models import Work
    ...
    def test_work_fwci(self, mock_work_data):
        """Test that field-weighted citation impact is parsed correctly."""
        from openalex.models import Work
    ...
    def test_work_helper_methods(self, mock_work_data):
        """Test that helper methods return expected values."""
        from openalex.models import Work
    ...
    def test_work_minimal_data(self):
        """Test that work model works with minimal required fields."""
        from openalex.models import Work
    ...
    def test_work_validation_errors(self):
        """Test that validation errors are raised for invalid work data."""
        from openalex.models import Work
    ...
    def test_work_with_versions(self):
        """Test that work with multiple versions/locations is handled correctly."""
        from openalex.models import Work
    ...
    def test_work_corresponding_authors(self, mock_work_data):
        """Test that corresponding author information is properly structured."""
        from openalex.models import Work
    ...
    def test_work_institution_assertions(self, mock_work_data):
        """Test that institution assertions are handled correctly."""
        from openalex.models import Work
    ...
    def test_work_countries_distinct_count(self, mock_work_data):
        """Test that countries distinct count is calculated correctly."""
        from openalex.models import Work
    ...
    def test_work_institutions_distinct_count(self, mock_work_data):
        """Test that institutions distinct count is calculated correctly."""
        from openalex.models import Work
    ...
    def test_work_created_date(self, mock_work_data):
        """Test that created date field is parsed correctly."""
        from openalex.models import Work
    ...
    def test_work_indexed_in(self, mock_work_data):
        """Test that indexed_in field contains expected databases."""
        from openalex.models import Work
    ...
    def test_work_convenience_methods(self, mock_work_data):
        """Test that work model convenience methods return expected values."""
        from openalex.models import Work
