...
class TestPaginationBehavior:
    """Test suite for pagination behavior utilities."""
...
class TestRetryBehavior:
    """Test suite for retry behavior utilities."""
...
class TestParameterUtilities:
    """Test suite for parameter utilities."""
...
class TestLogging:
    ...
    def test_configure_logging_json_format(self):
        ...
        try:
            structlog.get_logger("openalex").info(
                "Test message", api_key="secret123"
            )
        except Exception as exc:
            pytest.fail(f"Logging raised an error: {exc}")
