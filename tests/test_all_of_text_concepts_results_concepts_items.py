...
class TestAllOfTextConceptsResultsConceptsItems(unittest.TestCase):
    """AllOfTextConceptsResultsConceptsItems unit test stubs"""
    ...
    def testAllOfTextConceptsResultsConceptsItems(self):
        """Test AllOfTextConceptsResultsConceptsItems"""
        pass
